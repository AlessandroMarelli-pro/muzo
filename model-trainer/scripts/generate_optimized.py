"""
Create Personal Music Dataset - High Performance Version
...
def create_personal_dataset(
    ...
    """
    print("=" * 60)
    print("CREATING PERSONAL MUSIC DATASET - HIGH PERFORMANCE")
    print("=" * 60)
    ...
    if total_files == 0:
        ...
        all_features = process_files_parallel(all_file_args, max_workers=max_workers)
