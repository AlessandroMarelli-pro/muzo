#!/usr/bin/env python3
"""
Test UB40 song with the personal genres model
"""
...
def test_ub40_with_personal_genres_model():
    """Test UB40 song with the personal genres model."""

    print("=" * 60)
    print("TESTING UB40 SONG WITH GTZAN FORMAT GENRES MODEL")
    print("=" * 60)
    ...
    model_path = "models/personal-genres-gtzan-v1.0.pkl"

    if not Path(model_path).exists():
        print(f"❌ Model file not found: {model_path}")
        return False

    print(f"✅ Loading GTZAN format genres model from: {model_path}")
    ...
    try:
        ...
        output = {
            "song_info": {
                "filename": "UB40 - Kingston Town.flac",
                "file_path": song_path,
            ...
            "success": True,
            "timestamp": "2025-09-20T09:45:00",
        }

        # Print results
        print(f"\n🎯 Classification Results:")
        print(f"   - Predicted genre: {result['primary_genre']}")
        print(
        ...
        # Save JSON output
        output_file = "ub40_gtzan_genres_classification.json"
...
if __name__ == "__main__":
    success = test_ub40_with_personal_genres_model()
