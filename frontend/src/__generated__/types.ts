				...
				tracks: {
					...
					items?: Array<{
						...
						aiMetadata: {
							...
							vocalsDesc?: string | null;
							description?: string | null;
							vocalsDescriptions?: string | null;
							atmosphereKeywords?: Array<string> | null;
							contextBackgrounds?: string | null;
							contextImpacts?: string | null;
						};
						musicalFeatures: {
							__typename?: 'TrackMusicalFeatures';
							tempo?: number | null;
...
export type GetRandomTrackWithStatsQueryVariables = Exact<{
	[key: string]: never;
}>;
...
export type GetStaticFiltersQuery = {
	...
	me: {
		...
		staticFilterOptions: {
			__typename?: 'StaticFilterOptions';
			genres: Array<{ __typename?: 'FilterWithID'; id: any; name: string }>;
			subgenres: Array<{ __typename?: 'FilterWithID'; id: any; name: string }>;
			keys: Array<{ __typename?: 'FilterWithID'; id: any; name: string }>;
			libraries: Array<{ __typename?: 'FilterWithID'; id: any; name: string }>;
			atmospheres: Array<{
				__typename?: 'FilterWithID';
				id: any;
				name: string;
...
export type DeleteActiveFilterMutation = {
	__typename?: 'Mutation';
...
export type GetWaveformDataQuery = {
	...
	me: {
		...
		musicPlayer: {
			__typename?: 'MusicPlayer';
			currentWaveformData?: Array<number> | null;
		};
	};
};
...
export type RegisterPlayedTrackMutation = {
	__typename?: 'Mutation';
	registerPlayedTrack: boolean;
};
...
export type ExportPlaylistToM3UMutation = {
	__typename?: 'Mutation';
	exportPlaylistToM3U: string;
};
...
export type ResetQueueMutation = {
	__typename?: 'Mutation';
	resetQueue: boolean;
};
