          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{library?.totalTracks.toLocaleString()}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">
                  {new Set(tracks.flatMap((t) => t?.genres || []).filter(Boolean)).size}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{new Set(tracks?.map((t) => t.format)).size}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Explore different views of your music library data</CardDescription>
            </div>
            <div className="flex items-center space-x-2">
              {onExportData && (
