...
export function TidalSync({ onSync, disabled = false }: TidalSyncProps) {
  ...
  const { getAuthUrl, authenticate, isGettingAuthUrl, isAuthenticating } = useTidalAuth('default');
          ...
          <div className="space-y-4">
            {isGettingAuthUrl ? (
              ...
              <>
                ...
                <div>
                  <p className="text-sm text-muted-foreground mb-2">
                    2. After authorizing, TIDAL will redirect you to a page. Look at the URL in your
                    browser's address bar and copy the{' '}
