...
interface InlinePlaylistCardProps {
  playlist: Playlist & { disabled?: boolean };
...
export function InlinePlaylistCard({ playlist, onCardClick }: InlinePlaylistCardProps) {
  const disabled = playlist.containsTrack;
