        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4 ">
            ...
            <div className="space-y-4 pt-2 border-t">
              ...
              {formData.autoScan && (
                <Field orientation="horizontal">
                  <FieldLabel htmlFor="scanInterval">Scan Interval (hours)</FieldLabel>
                  <Input
                    id="scanInterval"
                    type="number"
                    min="1"
                  ...
                  />
                  {errors.scanInterval && (
                    <p className="text-sm text-red-600">{errors.scanInterval}</p>
                  )}
                </Field>
              )}
              ...
              <Field orientation="horizontal">
                <FieldLabel htmlFor="maxFileSize">Max File Size (MB)</FieldLabel>
                <Input
                  id="maxFileSize"
                  type="number"
                  min="1"
                  ...
                  className="w-xs"
                />
                {errors.maxFileSize && <p className="text-sm text-red-600">{errors.maxFileSize}</p>}
              </Field>
            </div>
