...
This folder documents the NestJS backend's **Clean Architecture** implementation under `backend/src/`. Dependencies point **inward**: inner layers do not import from outer layers.
