...
export const ConfigModuleSetup = ConfigModule.forRoot({
  isGlobal: true,
  load: [databaseConfig, aiServiceConfig, appConfig, queueConfig, elasticsearchConfig],
...
export { aiServiceConfig, appConfig, databaseConfig, elasticsearchConfig, queueConfig };
