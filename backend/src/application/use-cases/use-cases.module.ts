...
import {
  ...
  GetFavoriteUseCase,
  GetHiddenTrackImageUseCase,
  GetHiddenTrackUseCase,
...
const useCasesProviders = [
  ...
  createUseCaseProvider(DuplicatePlaylistUseCase, [
    PLAYLIST_REPOSITORY,
    PLAYLIST_TRACK_REPOSITORY,
    PLAYLIST_SORTING_REPOSITORY,
    LOGGER,
  ]),
  createUseCaseProvider(MergePlaylistsUseCase, [
    PLAYLIST_REPOSITORY,
    PLAYLIST_TRACK_REPOSITORY,
    PLAYLIST_SORTING_REPOSITORY,
    LOGGER,
  ...
  createUseCaseProvider(GetHiddenTracksUseCase, [HIDDEN_MUSIC_TRACK_REPOSITORY]),
  createUseCaseProvider(GetHiddenTrackUseCase, [HIDDEN_MUSIC_TRACK_REPOSITORY]),
  createUseCaseProvider(GetHiddenTrackImageUseCase, [HIDDEN_MUSIC_TRACK_REPOSITORY]),
  createUseCaseProvider(RestoreHiddenTrackUseCase, [
    HIDDEN_MUSIC_TRACK_REPOSITORY,
    MUSIC_TRACK_REPOSITORY,
    LOGGER_FACTORY,
    LOGGER,
