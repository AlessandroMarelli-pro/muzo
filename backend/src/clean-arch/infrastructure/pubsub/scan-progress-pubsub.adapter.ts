...
import { IScanProgressPublisher } from 'src/clean-arch/application/ports/infrastructure/IScanProgressPublisher';
import { IScanProgressSubscriber } from 'src/clean-arch/application/ports/infrastructure/IScanProgressSubscriber';
...
export class ScanProgressPubSubAdapter
  implements IScanProgressPublisher, IScanProgressSubscriber, OnModuleDestroy
{
