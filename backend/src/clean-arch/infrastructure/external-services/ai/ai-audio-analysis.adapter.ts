...
import { AudioAnalysisBatchResponse } from 'src/clean-arch/application/ports/dtos/AudioAnalysis';
import {
  AI_SERVICE_POOL,
  IAiServicePool,
} from 'src/clean-arch/application/ports/infrastructure/IAiServicePool';
import { IAudioAnalysisStructure } from 'src/clean-arch/application/ports/infrastructure/IAudioAnalysisStructure';
