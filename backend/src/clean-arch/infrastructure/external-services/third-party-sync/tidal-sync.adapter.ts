import {
  ...
  TidalAuthUrlResult,
  TrackMatchResult,
} from 'src/clean-arch/application/ports/infrastructure/ITidalSyncProvider';
import {
  IOAuthTokenRepository,
  OAUTH_TOKEN_REPOSITORY,
} from 'src/clean-arch/application/ports/repositories/IOAuthTokenRepository';
...
export class TidalSyncAdapter implements ITidalSyncProvider {
  ...
  private async searchTracks(
    ...
    const response = (await this.makeRequest(
      ...
      { method: 'GET' },
    )) as { data?: Array<{ type: string; id: string; attributes?: { title?: string; duration?: string }; relationships?: unknown }> };
