...
INSERT INTO "new_scan_sessions" ("completedAt", "completedBatches", "completedTracks", "createdAt", "errorMessage", "failedTracks", "id", "overallProgress", "sessionId", "startedAt", "status", "totalBatches", "totalTracks", "updatedAt") SELECT "completedAt", "completedBatches", "completedTracks", "createdAt", "errorMessage", "failedTracks", "id", "overallProgress", "sessionId", "startedAt", "status", "totalBatches", "totalTracks", "updatedAt" FROM "scan_sessions";
