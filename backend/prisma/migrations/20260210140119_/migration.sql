/*
  ...
  - You are about to drop the `ai_analysis_results` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropIndex
DROP INDEX "ai_analysis_results_fingerprintId_key";

-- DropIndex
DROP INDEX "ai_analysis_results_trackId_key";
