/*
  ...
  - You are about to drop the column `atmosphereDesc` on the `hidden_music_tracks` table. All the data in the column will be lost.
...
INSERT INTO "new_hidden_music_tracks" ("aiAlbum", "aiArtist", "aiConfidence", "aiDescription", "aiSubgenreConfidence", "aiTags", "aiTitle", "analysisCompletedAt", "analysisError", "analysisStartedAt", "analysisStatus", "bitrate", "contextBackground", "contextImpact", "createdAt", "createdById", "duration", "fileName", "filePath", "fileSize", "format", "hasDiscogs", "hasMusicbrainz", "id", "isBanger", "isFavorite", "isLiked", "lastPlayedAt", "libraryId", "listeningCount", "originalAlbum", "originalAlbumartist", "originalArtist", "originalBpm", "originalComment", "originalComposer", "originalCopyright", "originalDate", "originalDisc_number", "originalTitle", "originalTrack_number", "originalYear", "sampleRate", "updatedAt", "updatedById", "userAlbum", "userArtist", "userTags", "userTitle", "vocalsDesc") SELECT "aiAlbum", "aiArtist", "aiConfidence", "aiDescription", "aiSubgenreConfidence", "aiTags", "aiTitle", "analysisCompletedAt", "analysisError", "analysisStartedAt", "analysisStatus", "bitrate", "contextBackground", "contextImpact", "createdAt", "createdById", "duration", "fileName", "filePath", "fileSize", "format", "hasDiscogs", "hasMusicbrainz", "id", "isBanger", "isFavorite", "isLiked", "lastPlayedAt", "libraryId", "listeningCount", "originalAlbum", "originalAlbumartist", "originalArtist", "originalBpm", "originalComment", "originalComposer", "originalCopyright", "originalDate", "originalDisc_number", "originalTitle", "originalTrack_number", "originalYear", "sampleRate", "updatedAt", "updatedById", "userAlbum", "userArtist", "userTags", "userTitle", "vocalsDesc" FROM "hidden_music_tracks";
