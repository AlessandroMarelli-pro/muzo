/*
  ...
  - You are about to drop the column `camelot_key` on the `audio_fingerprints` table. All the data in the column will be lost.
...
INSERT INTO "new_audio_fingerprints" ("acousticness", "arousal", "arousalMood", "audioHash", "bassPresence", "beatStrength", "brightnessFactor", "chroma", "createdAt", "danceability", "danceabilityFeeling", "energyByBand", "energyComment", "energyFactor", "energyKeywords", "fileHash", "harmonicFactor", "id", "instrumentalness", "key", "liveness", "mfcc", "modeConfidence", "modeFactor", "modeWeight", "rhythmStability", "rms", "spectralBalance", "spectralBandwith", "spectralCentroid", "spectralContrast", "spectralFlatness", "spectralRolloff", "spectralSpread", "speechiness", "syncopation", "tempo", "tempoAppropriateness", "tempoFactor", "tempoRegularity", "tonnetz", "trackId", "updatedAt", "valence", "valenceMood", "zeroCrossingRate") SELECT "acousticness", "arousal", "arousalMood", "audioHash", "bassPresence", "beatStrength", "brightnessFactor", "chroma", "createdAt", "danceability", "danceabilityFeeling", "energyByBand", "energyComment", "energyFactor", "energyKeywords", "fileHash", "harmonicFactor", "id", "instrumentalness", "key", "liveness", "mfcc", "modeConfidence", "modeFactor", "modeWeight", "rhythmStability", "rms", "spectralBalance", "spectralBandwith", "spectralCentroid", "spectralContrast", "spectralFlatness", "spectralRolloff", "spectralSpread", "speechiness", "syncopation", "tempo", "tempoAppropriateness", "tempoFactor", "tempoRegularity", "tonnetz", "trackId", "updatedAt", "valence", "valenceMood", "zeroCrossingRate" FROM "audio_fingerprints";
